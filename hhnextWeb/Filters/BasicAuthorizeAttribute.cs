        ...
        public override Task OnAuthorizationAsync(HttpActionContext actionContext, CancellationToken cancellationToken)
        {
            ...
            if (authHeader != null)
            {
                    ...
                    !String.IsNullOrWhiteSpace(authHeader.Parameter))
                {
                    ...
                    Task<AppUser> user = actionContext.Request.GetOwinContext().GetUserManager<AppUserManager>().FindAsync(userName, password);
                    ...
                    if (user.Result != null)
                    {
                        ...
                        //actionContext.Request.Properties.Add("currentUserName", userName);
                        //actionContext.Request.Properties.Add("currentUserId", user.Result.Id);
                        return nullTask;
                    }
                    //}
                }
